...
//Command     : generate_target Block_Diagram_LCD.bd
//Design      : Block_Diagram_LCD
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Block_Diagram_LCD,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Block_Diagram_LCD,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=21,numReposBlks=20,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_mb_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "Block_Diagram_LCD.hwdef" *) 
module Block_Diagram_LCD
   (AXI_CLK,
    ...
    UART_TX,
    gpio2_io_o_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.AXI_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AXI_CLK, CLK_DOMAIN Block_Diagram_LCD_mig_7series_0_0_ui_clk, FREQ_HZ 83333333, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) output AXI_CLK;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_IN CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_IN, CLK_DOMAIN Block_Diagram_LCD_CLK_IN, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input CLK_IN;
  ...
  wire [6:0]smartconnect_0_M04_AXI_ARADDR;
  wire smartconnect_0_M04_AXI_ARREADY;
  wire smartconnect_0_M04_AXI_ARVALID;
  wire [6:0]smartconnect_0_M04_AXI_AWADDR;
  ...
  Block_Diagram_LCD_axi_gpio_0_0 axi_gpio_0
  ...
  Block_Diagram_LCD_axi_intc_0_0 axi_intc_0
  ...
  Block_Diagram_LCD_axi_quad_spi_0_0 axi_quad_spi_0
       (.ext_spi_clk(AXI_CLK),
        .io0_i(1'b0),
        .io0_o(DISPLAY_MOSI),
        .io1_i(DISPLAY_MISO),
        ...
        .ss_i(1'b0),
        .ss_o(DISPLAY_CSn));
  Block_Diagram_LCD_axi_timer_0_0 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
  ...
  Block_Diagram_LCD_axi_uartlite_0_0 axi_uartlite_0
       (.interrupt(axi_uartlite_0_interrupt),
        ...
        .tx(UART_TX));
  Block_Diagram_LCD_clk_wiz_1_0 clk_wiz_1
       (.clk_in1(CLK_IN),
        .clk_out1(clk_wiz_1_clk_out1),
        .clk_out2(clk_wiz_1_clk_out2),
        .locked(clk_wiz_1_locked),
        .reset(RST));
  Block_Diagram_LCD_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > Block_Diagram_LCD microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Block_Diagram_LCD_microblaze_0_0 microblaze_0
  ...
  microblaze_0_local_memory_imp_1Q6FJHA microblaze_0_local_memory
  ...
  Block_Diagram_LCD_mig_7series_0_0 mig_7series_0
  ...
  Block_Diagram_LCD_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
  ...
  Block_Diagram_LCD_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aclk(AXI_CLK),
        .aresetn(rst_clk_wiz_1_100M_peripheral_aresetn));
  Block_Diagram_LCD_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(RST),
        .Res(util_vector_logic_0_Res));
  Block_Diagram_LCD_util_vector_logic_1_0 util_vector_logic_1
       (.Op1(mig_7series_0_ui_clk_sync_rst),
        .Res(util_vector_logic_1_Res));
  Block_Diagram_LCD_xlconcat_0_0 xlconcat_0
       (.In0(SW_0),
        .In1(SW_1),
        .In2(PB_1),
        .In3(PB_2),
  ...
  Block_Diagram_LCD_xlconcat_1_0 xlconcat_1
...
module microblaze_0_local_memory_imp_1Q6FJHA
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > Block_Diagram_LCD microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Block_Diagram_LCD_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  Block_Diagram_LCD_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  Block_Diagram_LCD_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  Block_Diagram_LCD_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  Block_Diagram_LCD_lmb_bram_0 lmb_bram
