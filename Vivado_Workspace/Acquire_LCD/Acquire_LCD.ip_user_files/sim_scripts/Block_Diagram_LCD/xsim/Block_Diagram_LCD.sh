...
#
# Script generated by Vivado on Tue Nov 11 05:48:04 -0500 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Block_Diagram_LCD.sh
...
#
# Usage        : Block_Diagram_LCD.sh
#                Block_Diagram_LCD.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Block_Diagram_LCD.sh [-reset_run]
#                Block_Diagram_LCD.sh [-reset_log]
#                Block_Diagram_LCD.sh [-help]
#
...
# script info
echo -e "Block_Diagram_LCD.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Block_Diagram_LCD.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L microblaze_v11_0_14 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L axi_lite_ipif_v3_0_4 -L mdm_v3_2_27 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L axi_vip_v1_1_19 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L lib_pkg_v1_0_4 -L axi_timer_v2_0_35 -L xlconcat_v2_1_6 -L lib_srl_fifo_v1_0_4 -L axi_uartlite_v2_0_37 -L dist_mem_gen_v8_0_15 -L fifo_generator_v13_2_11 -L lib_fifo_v1_0_20 -L axi_quad_spi_v3_2_32 -L axi_intc_v4_1_20 -L util_vector_logic_v2_0_4 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Block_Diagram_LCD xil_defaultlib.Block_Diagram_LCD xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Block_Diagram_LCD -key {Behavioral:sim_1:Functional:Block_Diagram_LCD} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_017a.protoinst" -protoinst "protoinst_files/Block_Diagram_LCD.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Block_Diagram_LCD.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Block_Diagram_LCD.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Block_Diagram_LCD.sh [-help]\n\
Usage: Block_Diagram_LCD.sh [-step]\n\
Usage: Block_Diagram_LCD.sh [-lib_map_path]\n\
Usage: Block_Diagram_LCD.sh [-reset_run]\n\
Usage: Block_Diagram_LCD.sh [-reset_log]\n\
Usage: Block_Diagram_LCD.sh [-keep_index]\n\
Usage: Block_Diagram_LCD.sh [-noclean_files]\n\n\
