...
#                script (type 'Block_Diagram_LCD.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/IMR_Projects/IMR/Acquire_FPGA/Vivado_Workspace/Acquire_LCD/Acquire_LCD.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
