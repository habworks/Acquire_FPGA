...
HD_PWD='C:/IMR_Projects/IMR/Acquire_FPGA/Vivado_Workspace/Acquire_ADC/Acquire_ADC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Diagram_ADC_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Block_Diagram_ADC_wrapper.tcl -notrace
