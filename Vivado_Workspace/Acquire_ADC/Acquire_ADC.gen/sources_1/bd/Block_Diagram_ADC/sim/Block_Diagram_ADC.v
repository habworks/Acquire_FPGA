...
//Command     : generate_target Block_Diagram_ADC.bd
//Design      : Block_Diagram_ADC
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Block_Diagram_ADC,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Block_Diagram_ADC,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=21,numReposBlks=20,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=9,da_clkrst_cnt=5,da_mb_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "Block_Diagram_ADC.hwdef" *) 
module Block_Diagram_ADC
  ...
  input ADC_TEST_2;
  input ADC_TEST_3;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_IN CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_IN, CLK_DOMAIN Block_Diagram_ADC_CLK_IN, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input CLK_IN;
  ...
  Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7 IMR_ADC_7476A_V1_0_0
       (.ADC_CS_n(ADC_CS_n_0),
        .ADC_MISO_A(ADC_MISO_A_0),
        .ADC_MISO_B(ADC_MISO_B_0),
        .ADC_SCLK(ADC_SCLK_0),
        .IRQ(IRQ_0),
  ...
  Block_Diagram_ADC_axi_gpio_0_0 axi_gpio_0
  ...
  Block_Diagram_ADC_axi_intc_0_0 axi_intc_0
  ...
  Block_Diagram_ADC_axi_timer_0_0 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
  ...
  Block_Diagram_ADC_axi_uartlite_0_0 axi_uartlite_0
       (.interrupt(axi_uartlite_0_interrupt),
        ...
        .tx(UART_TX));
  Block_Diagram_ADC_clk_wiz_1_0 clk_wiz_1
       (.clk_in1(CLK_IN),
        .clk_out1(clk_wiz_1_clk_out1),
        .locked(clk_wiz_1_locked),
        .reset(RST_H));
  Block_Diagram_ADC_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > Block_Diagram_ADC microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Block_Diagram_ADC_microblaze_0_0 microblaze_0
  ...
  microblaze_0_local_memory_imp_G2AOVD microblaze_0_local_memory
  ...
  Block_Diagram_ADC_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
  ...
  Block_Diagram_ADC_smartconnect_0_0 smartconnect_0
  ...
  Block_Diagram_ADC_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(RST_H),
        .Res(util_vector_logic_0_Res));
  Block_Diagram_ADC_xlconcat_0_0 xlconcat_0
       (.In0(axi_uartlite_0_interrupt),
        .In1(axi_timer_0_interrupt),
        .In2(IRQ_0),
        .In3(ADC_Done),
        .dout(xlconcat_0_dout));
  Block_Diagram_ADC_xlconcat_1_0 xlconcat_1
       (.In0(SW_0),
        .In1(SW_1),
        .In2(SW_2),
        .In3(ADC_TEST_1),
  ...
  Block_Diagram_ADC_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  Block_Diagram_ADC_xlslice_0_0 xlslice_0
       (.Din(gpio2_io_o_0),
        .Dout(ADC_Done));
endmodule

module microblaze_0_local_memory_imp_G2AOVD
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > Block_Diagram_ADC microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Block_Diagram_ADC_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  Block_Diagram_ADC_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  Block_Diagram_ADC_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  Block_Diagram_ADC_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  Block_Diagram_ADC_lmb_bram_0 lmb_bram
