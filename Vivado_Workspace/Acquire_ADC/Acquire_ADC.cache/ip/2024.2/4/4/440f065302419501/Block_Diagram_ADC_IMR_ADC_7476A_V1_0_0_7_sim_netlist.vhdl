...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_imr_adc_7476a_core is
  port (
    ...
    \s00_axi_rdata[27]\ : in STD_LOGIC_VECTOR ( 15 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_imr_adc_7476a_core is
  ...
  signal ClockDividerCount1 : STD_LOGIC;
  ...
  signal StatusDebug : STD_LOGIC;
  signal \StatusDebug[3]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of ADC_CLK_i_1 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of IRQ_INST_0 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ShiftBitCount[1]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of StatusBusy_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \StatusDebug[3]_i_2\ : label is "soft_lutpair3";
begin
...
ADC_CLK_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1FE0"
    )
        port map (
...
\ClockDividerCount[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\ClockDividerCount[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"15554000"
    )
        port map (
...
StatusBusy_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"DDDD8CCC"
    )
        port map (
...
u_adc_core: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_imr_adc_7476a_core
     port map (
      ...
      IRQ => IRQ,
      Q(15) => \slv_reg0_reg_n_0_[27]\,
      Q(14) => \slv_reg0_reg_n_0_[26]\,
      Q(13) => \slv_reg0_reg_n_0_[25]\,
      Q(12) => \slv_reg0_reg_n_0_[24]\,
      Q(11 downto 8) => TotalConversions(3 downto 0),
      ...
      s00_axi_rdata(15 downto 12) => s00_axi_rdata(27 downto 24),
      s00_axi_rdata(11 downto 0) => s00_axi_rdata(11 downto 0),
      \s00_axi_rdata[27]\(15) => \slv_reg4_reg_n_0_[27]\,
      \s00_axi_rdata[27]\(14) => \slv_reg4_reg_n_0_[26]\,
      \s00_axi_rdata[27]\(13) => \slv_reg4_reg_n_0_[25]\,
      \s00_axi_rdata[27]\(12) => \slv_reg4_reg_n_0_[24]\,
      \s00_axi_rdata[27]\(11) => \slv_reg4_reg_n_0_[11]\,
