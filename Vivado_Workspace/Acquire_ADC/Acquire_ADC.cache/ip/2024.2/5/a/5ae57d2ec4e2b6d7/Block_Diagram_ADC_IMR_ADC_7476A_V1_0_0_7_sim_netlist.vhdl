...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_imr_adc_7476a_core is
  ...
  attribute SOFT_HLUTNM of ADC_CS_n_INST_0 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ClockDividerCount[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ClockDividerCount[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ClockDividerCount[3]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of Continuous_Delay_1_Clk_i_1 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \ConversionCount[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \ConversionCount[10]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \ConversionCount[11]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \ConversionCount[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \ConversionCount[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \ConversionCount[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \ConversionCount[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \ConversionCount[5]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \ConversionCount[6]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \ConversionCount[7]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \ConversionCount[8]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ConversionCount[9]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_State[5]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FSM_onehot_State[5]_i_4\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \QuietCnt[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \QuietCnt[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ShiftBitCount[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \ShiftBitCount[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ShiftBitCount[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of Single_Delay_1_Clk_i_1 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of StatusBusy_i_2 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \StatusDebug[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \StatusDebug[3]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \s00_axi_rdata[10]_INST_0_i_2\ : label is "soft_lutpair1";
begin
...
\ClockDividerCount[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000028888888"
        ...
        port map (
      I0 => \ClockDividerCount[3]_i_3_n_0\,
...
\FSM_onehot_State[5]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"082A000000000000"
    )
        port map (
      I0 => Q(1),
      I1 => Q(2),
      I2 => Continuous_Delay_1_Clk,
...
\StatusDebug[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FC88CC88"
    )
        port map (
...
\StatusDebug[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EEEEEEEE000CCCCC"
    )
        port map (
      I0 => \FSM_onehot_State_reg_n_0_[1]\,
      I1 => p_0_in_0,
      I2 => \QuietCnt_reg_n_0_[0]\,
      I3 => \QuietCnt_reg_n_0_[1]\,
      I4 => \QuietCnt_reg_n_0_[2]\,
      I5 => slv_reg1(14),
      O => StatusDebug(2)
    );
...
\StatusDebug[3]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
\StatusDebug[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A8"
    )
        port map (
...
\s00_axi_rdata[10]_INST_0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
