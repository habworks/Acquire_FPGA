...
#                script (type 'Block_Diagram_ADC.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/IMR_Projects/IMR/Acquire_FPGA/Vivado_Workspace/Acquire_ADC/Acquire_ADC.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
