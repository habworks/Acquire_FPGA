...
-- Date        : Sat Oct 25 10:19:29 2025
-- Host        : LAPTOP-6I567M9C running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7 -prefix
--               Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_ Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_sim_netlist.vhdl
...
entity Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_core is
  port (
    ...
    \s00_axi_rdata[27]\ : in STD_LOGIC_VECTOR ( 26 downto 0 );
    s00_axi_rdata_2_sp_1 : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
    ADC_MISO_A : in STD_LOGIC;
    ADC_MISO_B : in STD_LOGIC
  );
end Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_core;

architecture STRUCTURE of Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_core is
  ...
  signal StatusBusy_1 : STD_LOGIC;
  signal StatusBusy_i_1_n_0 : STD_LOGIC;
  signal StatusBusy_i_2_n_0 : STD_LOGIC;
  signal StatusDebug : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \StatusDebug[3]_i_1_n_0\ : STD_LOGIC;
  signal \StatusDebug[3]_i_3_n_0\ : STD_LOGIC;
  ...
  signal in13 : STD_LOGIC_VECTOR ( 11 downto 1 );
  ...
  signal slv_reg1 : STD_LOGIC_VECTOR ( 15 downto 1 );
  ...
  attribute SOFT_HLUTNM of ADC_CS_n_INST_0 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ClockDividerCount[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \ClockDividerCount[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \ClockDividerCount[3]_i_3\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of IRQ_INST_0 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \QuietCnt[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \QuietCnt[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ShiftBitCount[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ShiftBitCount[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ShiftBitCount[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \ShiftBitCount[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of Single_Delay_1_Clk_i_1 : label is "soft_lutpair3";
...
ADC_CS_n_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\QuietCnt[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"44BF5500"
    )
        port map (
      I0 => StatusReady,
      I1 => \QuietCnt_reg_n_0_[2]\,
      I2 => \QuietCnt_reg_n_0_[1]\,
      I3 => \QuietCnt_reg_n_0_[0]\,
      I4 => p_0_in_0,
      O => \QuietCnt[0]_i_1_n_0\
    );
\QuietCnt[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4BF05050"
    )
        port map (
...
\QuietCnt[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7CCC4444"
    )
        port map (
...
StatusBusy_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"ABA8"
    )
        port map (
...
StatusBusy_i_2: unisim.vcomponents.LUT6
    generic map(
...
\StatusDebug[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFF1F1F000"
    )
        port map (
      I0 => State11_in,
      I1 => SingleConversion,
...
\StatusDebug[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
\StatusDebug[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFAEEE"
    )
        port map (
      ...
      I2 => \s00_axi_rdata[27]\(0),
      I3 => slv_reg1(1),
      I4 => \StatusDebug[3]_i_3_n_0\,
      O => \StatusDebug[3]_i_1_n_0\
    );
\StatusDebug[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFF2F2F000"
    )
        port map (
      I0 => Q(1),
      I1 => Q(2),
...
\StatusDebug[3]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"E0000000"
    )
        port map (
      ...
      I2 => p_0_in_0,
      I3 => \QuietCnt_reg_n_0_[2]\,
      I4 => Q(1),
      O => \StatusDebug[3]_i_3_n_0\
    );
\StatusDebug_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => \StatusDebug[3]_i_1_n_0\,
      CLR => \^s00_axi_aresetn_0\,
      D => StatusDebug(0),
      Q => slv_reg1(12)
    );
...
\StatusDebug_reg[3]\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => \StatusDebug[3]_i_1_n_0\,
      CLR => \^s00_axi_aresetn_0\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_v1_0_slave_lite_v1_0_S00_AXI is
  port (
...
end Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_v1_0_slave_lite_v1_0_S00_AXI;

architecture STRUCTURE of Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_v1_0_slave_lite_v1_0_S00_AXI is
...
u_adc_core: entity work.Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_core
     port map (
      ...
      Q(19 downto 8) => TotalConversions(11 downto 0),
      Q(7 downto 4) => ClockDivider_N(3 downto 0),
      Q(3) => \slv_reg0_reg_n_0_[3]\,
      Q(2 downto 0) => slv_reg0(2 downto 0),
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn,
      s00_axi_aresetn_0 => u_adc_core_n_0,
      s00_axi_rdata(27 downto 0) => s00_axi_rdata(27 downto 0),
      \s00_axi_rdata[27]\(26) => \slv_reg4_reg_n_0_[27]\,
      \s00_axi_rdata[27]\(25) => \slv_reg4_reg_n_0_[26]\,
      \s00_axi_rdata[27]\(24) => \slv_reg4_reg_n_0_[25]\,
      \s00_axi_rdata[27]\(23) => \slv_reg4_reg_n_0_[24]\,
      \s00_axi_rdata[27]\(22) => \slv_reg4_reg_n_0_[23]\,
      \s00_axi_rdata[27]\(21) => \slv_reg4_reg_n_0_[22]\,
      \s00_axi_rdata[27]\(20) => \slv_reg4_reg_n_0_[21]\,
      \s00_axi_rdata[27]\(19) => \slv_reg4_reg_n_0_[20]\,
      \s00_axi_rdata[27]\(18) => \slv_reg4_reg_n_0_[19]\,
      \s00_axi_rdata[27]\(17) => \slv_reg4_reg_n_0_[18]\,
      \s00_axi_rdata[27]\(16) => \slv_reg4_reg_n_0_[17]\,
      \s00_axi_rdata[27]\(15) => \slv_reg4_reg_n_0_[16]\,
      \s00_axi_rdata[27]\(14) => \slv_reg4_reg_n_0_[15]\,
      \s00_axi_rdata[27]\(13) => \slv_reg4_reg_n_0_[14]\,
      \s00_axi_rdata[27]\(12) => \slv_reg4_reg_n_0_[13]\,
      \s00_axi_rdata[27]\(11) => \slv_reg4_reg_n_0_[12]\,
      \s00_axi_rdata[27]\(10) => \slv_reg4_reg_n_0_[11]\,
      ...
      \s00_axi_rdata[27]\(2) => \slv_reg4_reg_n_0_[3]\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_v1_0 is
  port (
...
end Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_v1_0;

architecture STRUCTURE of Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_v1_0 is
begin
imr_adc_7476a_v1_0_slave_lite_v1_0_S00_AXI_inst: entity work.Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_v1_0_slave_lite_v1_0_S00_AXI
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7 is
  port (
  ...
  attribute NotValidForBitStream of Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7 : entity is "Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7,imr_adc_7476a_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7 : entity is "imr_adc_7476a_v1_0,Vivado 2024.2";
end Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7;

architecture STRUCTURE of Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7 is
...
inst: entity work.Block_Diagram_ADC_IMR_ADC_7476A_V1_0_0_7_imr_adc_7476a_v1_0
     port map (
