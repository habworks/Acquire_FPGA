...
HD_PWD='C:/IMR_Projects/IMR/Acquire_FPGA/Vivado_Workspace/Acquire_DDR3/Acquire_DDR3.runs/Block_Diagram_DDR3_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Diagram_DDR3_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_Diagram_DDR3_ilmb_v10_0.tcl
