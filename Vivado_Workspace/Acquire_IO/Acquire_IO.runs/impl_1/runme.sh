...
HD_PWD='C:/IMR_Projects/IMR/Acquire_FPGA/Acquire_IO/Acquire_IO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Diagram_IO_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Block_Diagram_IO_wrapper.tcl -notrace
