...
HD_PWD='C:/IMR_Projects/IMR/Acquire_FPGA/Acquire_IO/Acquire_IO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Diagram_IO_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_Diagram_IO_wrapper.tcl
