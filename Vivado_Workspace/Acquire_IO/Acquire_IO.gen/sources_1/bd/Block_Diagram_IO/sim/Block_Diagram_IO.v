...
//Command     : generate_target Block_Diagram_IO.bd
//Design      : Block_Diagram_IO
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Block_Diagram_IO,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Block_Diagram_IO,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=16,numReposBlks=15,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=7,da_mb_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "Block_Diagram_IO.hwdef" *) 
module Block_Diagram_IO
   (clk_in,
    ...
    gpio_io_i_1,
    reset_rtl_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_IN CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_IN, CLK_DOMAIN Block_Diagram_IO_clk_in, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_in;
  ...
  wire axi_gpio_irq_ip2intc_irpt;
  ...
  Block_Diagram_IO_axi_gpio_0_0 axi_gpio_0
  ...
  Block_Diagram_IO_axi_gpio_1_0 axi_gpio_irq
       (.gpio_io_i(gpio_io_i_1),
        .ip2intc_irpt(axi_gpio_irq_ip2intc_irpt),
        .s_axi_aclk(microblaze_0_Clk),
  ...
  Block_Diagram_IO_axi_intc_0_0 axi_intc_0
       (.intr(axi_gpio_irq_ip2intc_irpt),
  ...
  Block_Diagram_IO_axi_smc_0 axi_smc
  ...
  Block_Diagram_IO_clk_wiz_1_0 clk_wiz_1
       (.clk_in1(clk_in),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_1_locked),
        .reset(mdm_1_debug_sys_rst));
  Block_Diagram_IO_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > Block_Diagram_IO microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Block_Diagram_IO_microblaze_0_1 microblaze_0
  ...
  microblaze_0_local_memory_imp_1EPXEDI microblaze_0_local_memory
  ...
  Block_Diagram_IO_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
  ...
  Block_Diagram_IO_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(reset_rtl_0),
        .Res(util_vector_logic_0_Res));
  Block_Diagram_IO_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
endmodule

module microblaze_0_local_memory_imp_1EPXEDI
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > Block_Diagram_IO microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Block_Diagram_IO_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  Block_Diagram_IO_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  Block_Diagram_IO_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  Block_Diagram_IO_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  Block_Diagram_IO_lmb_bram_0 lmb_bram
