...
#                script (type 'Block_Diagram_IO.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/IMR_Projects/IMR/Acquire_FPGA/Acquire_IO/Acquire_IO.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
