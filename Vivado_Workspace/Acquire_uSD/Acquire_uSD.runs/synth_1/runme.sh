...
HD_PWD='C:/IMR_Projects/IMR/Acquire_FPGA/Vivado_Workspace/Acquire_uSD/Acquire_uSD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Diagram_uSD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_Diagram_uSD_wrapper.tcl
