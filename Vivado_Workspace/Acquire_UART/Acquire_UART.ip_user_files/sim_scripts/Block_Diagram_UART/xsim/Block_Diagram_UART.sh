...
#
# Script generated by Vivado on Wed Jul 23 12:54:32 -0400 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Block_Diagram_UART.sh
...
#
# Usage        : Block_Diagram_UART.sh
#                Block_Diagram_UART.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Block_Diagram_UART.sh [-reset_run]
#                Block_Diagram_UART.sh [-reset_log]
#                Block_Diagram_UART.sh [-help]
#
...
# script info
echo -e "Block_Diagram_UART.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Block_Diagram_UART.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Block_Diagram_UART.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Block_Diagram_UART.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Block_Diagram_UART.sh [-help]\n\
Usage: Block_Diagram_UART.sh [-step]\n\
Usage: Block_Diagram_UART.sh [-lib_map_path]\n\
Usage: Block_Diagram_UART.sh [-reset_run]\n\
Usage: Block_Diagram_UART.sh [-reset_log]\n\
Usage: Block_Diagram_UART.sh [-keep_index]\n\
Usage: Block_Diagram_UART.sh [-noclean_files]\n\n\
