...
//Command     : generate_target Block_Diagram_UART_Lite.bd
//Design      : Block_Diagram_UART_Lite
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Block_Diagram_UART_Lite,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Block_Diagram_UART_Lite,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=19,numReposBlks=18,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_mb_cnt=2,synth_mode=None}" *) (* HW_HANDOFF = "Block_Diagram_UART_Lite.hwdef" *) 
module Block_Diagram_UART_Lite
   (CLK_IN,
    ...
    UART_TX,
    gpio2_io_o_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_IN CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_IN, CLK_DOMAIN Block_Diagram_UART_Lite_CLK_IN, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input CLK_IN;
  input [0:0]RST_H;
  input [0:0]SW_0;
  input [0:0]SW_1;
  input [0:0]SW_2;
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.UART_IRQ INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.UART_IRQ, PortWidth 1, SENSITIVITY EDGE_RISING" *) output UART_IRQ;
  input UART_RX;
  output UART_TX;
  ...
  Block_Diagram_UART_Lite_axi_gpio_0_0 axi_gpio_0
  ...
  Block_Diagram_UART_Lite_axi_timer_0_0 axi_timer_0
       (.capturetrig0(1'b0),
        .capturetrig1(1'b0),
        .freeze(1'b0),
  ...
  Block_Diagram_UART_Lite_axi_uartlite_0_0 axi_uartlite_0
       (.interrupt(UART_IRQ),
        .rx(UART_RX),
        .s_axi_aclk(microblaze_0_Clk),
        ...
        .tx(UART_TX));
  Block_Diagram_UART_Lite_clk_wiz_1_0 clk_wiz_1
       (.clk_in1(CLK_IN),
        .clk_out1(microblaze_0_Clk),
        .locked(clk_wiz_1_locked),
        .reset(RST_H));
  Block_Diagram_UART_Lite_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > Block_Diagram_UART_Lite microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Block_Diagram_UART_Lite_microblaze_0_0 microblaze_0
  ...
  Block_Diagram_UART_Lite_microblaze_0_axi_intc_0 microblaze_0_axi_intc
  ...
  microblaze_0_local_memory_imp_HCGEVK microblaze_0_local_memory
  ...
  Block_Diagram_UART_Lite_microblaze_0_xlconcat_0 microblaze_0_xlconcat
       (.In0(axi_timer_0_interrupt),
        .In1(UART_IRQ),
        .dout(microblaze_0_intr));
  Block_Diagram_UART_Lite_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
  ...
  Block_Diagram_UART_Lite_smartconnect_0_0 smartconnect_0
  ...
  Block_Diagram_UART_Lite_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(RST_H),
        .Res(util_vector_logic_0_Res));
  Block_Diagram_UART_Lite_xlconcat_0_0 xlconcat_0
       (.In0(SW_0),
        .In1(SW_1),
        .In2(SW_2),
        .dout(xlconcat_0_dout));
  Block_Diagram_UART_Lite_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
endmodule

module microblaze_0_local_memory_imp_HCGEVK
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > Block_Diagram_UART_Lite microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Block_Diagram_UART_Lite_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  Block_Diagram_UART_Lite_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  Block_Diagram_UART_Lite_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  Block_Diagram_UART_Lite_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  Block_Diagram_UART_Lite_lmb_bram_0 lmb_bram
