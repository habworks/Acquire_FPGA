...
HD_PWD='C:/IMR_Projects/IMR/Acquire_FPGA/Vivado_Workspace/Acquire_Timer/Acquire_Timer.runs/Block_Diagram_Timer_microblaze_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Diagram_Timer_microblaze_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_Diagram_Timer_microblaze_0_2.tcl
