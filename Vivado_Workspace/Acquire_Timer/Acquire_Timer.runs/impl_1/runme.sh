...
HD_PWD='C:/IMR_Projects/IMR/Acquire_FPGA/Vivado_Workspace/Acquire_Timer/Acquire_Timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Diagram_Timer_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Block_Diagram_Timer_wrapper.tcl -notrace
