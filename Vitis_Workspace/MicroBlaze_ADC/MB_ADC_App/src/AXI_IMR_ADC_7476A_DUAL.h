...
// DEFINES
// ADDRESS OFFSET
#define ADC_BASEADDR            XPAR_IMR_ADC_7476A_V1_0_0_BASEADDR
...
// MISC
#define XPAR_FABRIC_ADC_IP_0_INTR 2         // I manually created this based on the ADC IP IRQ connection to the Concat block (2 means 3rd connection counting from 0 [x:0] where x is last connection)
