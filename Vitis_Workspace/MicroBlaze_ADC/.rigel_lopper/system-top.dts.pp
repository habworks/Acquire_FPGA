# 0 "C:\\IMR_Projects\\IMR\\Acquire_FPGA\\Vitis_Workspace\\MicroBlaze_ADC\\MB_ADC_Platform\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:\\IMR_Projects\\IMR\\Acquire_FPGA\\Vitis_Workspace\\MicroBlaze_ADC\\MB_ADC_Platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\IMR_Projects\\IMR\\Acquire_FPGA\\Vitis_Workspace\\MicroBlaze_ADC\\MB_ADC_Platform\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  IMR_ADC_7476A_V1_0_0: IMR_ADC_7476A_V1_0@44a00000 {
   compatible = "xlnx,IMR-ADC-7476A-V1-0-1.8";
   interrupts = < 2 2 >;
   xlnx,s00-axi-data-width = <32>;
   xlnx,rable = <0>;
   interrupt-parent = <&axi_intc_0>;
   xlnx,ip-name = "IMR_ADC_7476A_V1_0";
   reg = <0x44a00000 0x10000>;
   xlnx,edk-iptype = "PERIPHERAL";
   status = "okay";
   xlnx,s00-axi-addr-width = <5>;
   interrupt-names = "IRQ";
   xlnx,name = "IMR_ADC_7476A_V1_0_0";
  };
...
# 3 "C:\\IMR_Projects\\IMR\\Acquire_FPGA\\Vitis_Workspace\\MicroBlaze_ADC\\MB_ADC_Platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7a100t";
 #address-cells = <1>;
 #size-cells = <1>;
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x10000>,
         ...
         <0x44a00000 &IMR_ADC_7476A_V1_0_0 0x44a00000 0x10000>;
