...
/* Definitions for peripheral AXI_GPIO_IRQ */
#define XPAR_AXI_GPIO_IRQ_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_AXI_GPIO_IRQ_BASEADDR 0x40010000
#define XPAR_AXI_GPIO_IRQ_HIGHADDR 0x4001ffff
#define XPAR_AXI_GPIO_IRQ_INTERRUPT_PRESENT 0x1
#define XPAR_AXI_GPIO_IRQ_IS_DUAL 0x0
#define XPAR_AXI_GPIO_IRQ_INTERRUPTS 0x2000
#define XPAR_FABRIC_AXI_GPIO_IRQ_INTR 0
#define XPAR_AXI_GPIO_IRQ_INTERRUPT_PARENT 0x41200001
#define XPAR_AXI_GPIO_IRQ_GPIO_WIDTH 0x2

/* Canonical definitions for peripheral AXI_GPIO_IRQ */
